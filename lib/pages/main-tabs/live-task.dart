    ...
    return Column(children: <Widget>[
      ...
      children: <Widget>[
        new Container(
          ...
          child: new Row(
            children: <Widget>[
              ...
              Expanded(
                  child: new Text(
                 orders[index]['createdAt'].toString().substring(0,10),
        ...
        new Container(
          ...
          color: Colors.white,
          child: new ListTile(            
            leading: new Image.network(orders[index]['productDetails'][0]['imageUrl'],
            height: 45.0,),
            title: new Text(
                        ...
                        new Row(
                          children: <Widget>[
                            Expanded(
                              child: new Padding(
                                  padding:
                                      EdgeInsets.only(left: 55.0, right: 30.0),
                                  child: new Text(
